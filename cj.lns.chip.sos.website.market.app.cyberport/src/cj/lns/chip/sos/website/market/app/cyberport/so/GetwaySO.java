package cj.lns.chip.sos.website.market.app.cyberport.so;
...
@CjSecurityObject(resourceDefineId = "getway", resourceDefineName = "信息网关", valueIdField = "id", valueNameField = "name", valueIconField = "icon")
@CjPermission(code = "visible", name = "可见")
public class GetwaySO {
	private String id;
