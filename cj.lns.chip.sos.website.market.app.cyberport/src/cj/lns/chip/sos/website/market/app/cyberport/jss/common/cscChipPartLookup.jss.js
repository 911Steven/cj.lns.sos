...
exports.flow = function(frame, circuit, plug, ctx) {
	...
	var result=lookup(computer,chip.tuple(),m);
	
	circuit.content().writeBytes(result);
}
function lookup(computer,chip,m){
	var f = new Frame(String.format("get /%s/csc/lookup.service csc/1.0",chip.name));
