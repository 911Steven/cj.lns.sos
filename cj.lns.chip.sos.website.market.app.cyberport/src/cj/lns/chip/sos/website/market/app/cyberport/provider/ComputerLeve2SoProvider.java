...
@CjService(name = "computerLevel2SecurityObjectProvider")
public class ComputerLeve2SoProvider implements ISecurityObjectProvider {
	private AppSO root;
	...
	private List<AppSO> getMountedApps(IServicewsContext ctx,String providers){
		...
		frame.parameter("platform", ctx.prop("portal.platform"));
	...
	public ISoProviderHandler init(String hostId, IAclFinder finder,
		...
		root.setDesc("云计算机服务窗口");
		root.setName("服务窗口");
		root.setCommand("./cyberportApp/common/csc.html");
		root.setId("site.computer.level2.home");
		root.setPhyId(
				BigInteger.valueOf(IWebsiteConstants.FIXED_APP_COMPUTER_LEVEL2));
		root.setPosition(ISurfacePosition.POSITION_TOOLBAR_WIN_APP);
		root.setSort(-10);
		root.setProvider(hostId);
		root.setIcon("img/csc.svg");
		AppPortal portal = new AppPortal();
//		portal.setLeft("./cyberportApp/left.html");
		portal.setRight("./cyberportApp/common/cscCustomers.html");
