...
@CjService(name = "cyberportSecurityObjectProvider")
public class CyberportSoProvider implements ISecurityObjectProvider {
	private AppSO root;
	...
	public ISoProviderHandler init(String hostId, IAclFinder finder,
		...
		root.setDesc("视窗的动态主页");
		root.setName("主页·动态");
		root.setCommand("./cyberportApp/index.html");
		root.setId("site.dynamic.home");
		root.setPhyId(
				BigInteger.valueOf(IWebsiteConstants.FIXED_APP_CYBERPORT));
...
//		portal.setRight("./cyberportApp/right.html");
