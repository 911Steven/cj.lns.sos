...
@CjService(name = "/joinChatroom2.service")
public class JoinChatroom2 implements IComponent {
	...
	public void flow(Frame frame, Circuit circuit, IPlug plug)
		...
		String cjql = "select {'tuple':'*'}.count() from tuple sns.chatroom.users java.lang.Long where {'tuple.crid':'?(crid)','tuple.user':'?(user)'}";
