...
@CjService(name="/develop.html")
public class DevelopComponent implements IComponent {
	...
	public void flow(Frame frame,Circuit circuit, IPlug plug) throws CircuitException {
		...
		if("feed".equals(let.getId())){
			Document doc=m.context().html("/develop.html",m.site().contextPath(),"utf-8");
