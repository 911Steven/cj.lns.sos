...
exports.flow = function(frame, circuit, plug, ctx) {
	...
	var tabtype=frame.parameter('tabtype');
	var marketid=frame.parameter('marketid');
	var chipname=frame.parameter('chipname');
	var csckey=frame.parameter('csckey');
	var csctype=frame.parameter('csctype');
	var csctitle=frame.parameter('csctitle');
	csctitle=URLDecoder.decode(csctitle);
	...
	var update=BsonDocument.parse(String.format("{$set:{'tuple.binder':{'marketid':'%s','chipname':'%s','csckey':'%s','csctype':'%s','csctitle':'%s'}}}",marketid,chipname,csckey,csctype,csctitle));
