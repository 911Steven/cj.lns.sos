...
@CjService(name = "setSosRoleCommand")
public class AddSosRoleCommand extends Command {
	...
	public void doCommand(CmdLine cl) throws IOException {
		...
		sos.addSosRoleToUser(name,line.getOptionValue("to"));
	}

	@Override
	public String cmdDesc() {
		return "为指定用户设置系统角色(在sos_role表中)，例：addRole sosUsers -to zhaoxb\r\n角色名,有：sosUsers(超级视窗申请权限),basicswsUsers(基础视窗申请权限),orgUsers(公共视窗申请权限）等";
	}
	...
	public Options options() {
		Options options = new Options();
		 Option mode = new Option("to", "to", true,
		 "要添加到的用户");
