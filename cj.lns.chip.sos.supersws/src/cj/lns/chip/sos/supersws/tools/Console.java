...
public abstract class Console implements IServiceSetter {
	...
	protected abstract String prefix(ISos sos, Object... target);

	protected abstract boolean exit(ISos sos,String cmd);

	public void monitor(ISos sos, Object... target)
			throws IOException {
		InputStreamReader input = new InputStreamReader(System.in);
		BufferedReader read = new BufferedReader(input);
		String prefix = prefix(sos, target);
...
//					}
				...
				cl.prop("indent", "  ");
				beforDoCommand(cmd, cl,target);
				cl.prop("target", target);
				cmd.doCommand(cl);
				System.out.print(prefix);
			} catch (Exception e) {
...
//				CJSystem.current().environment().logging().error(getClass(),e);
	...
	protected void printMan(ISos sos, Object[] target,
